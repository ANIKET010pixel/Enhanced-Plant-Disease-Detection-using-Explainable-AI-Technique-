...
**Outcome:**  
The solution was successfully copyrighted, ensuring protection of the intellectual property. The model using Inception V3 achieved an accuracy of 80-85% in disease detection. When integrated with Explainable AI (LIME), Inception V3 with XAI performed even better, achieving an impressive accuracy of 92-97%. This combination not only provided reliable disease predictions but also offered transparent visual explanations, making it highly effective for real-world agricultural applications
